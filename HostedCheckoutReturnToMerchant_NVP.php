...
<html>
    ...
    <head> <!-- replace MPGS_URL, e.g.:https://gpcbh.gateway.mastercard.com/checkout/version/57/checkout.js -->
       <script src="https://gpcbh.gateway.mastercard.com/checkout/version/57/checkout.js"  
               	 data-error="errorCallback"
               	 data-cancel="cancelCallback"
                 data-complete="https://localhost:8888/mpgs/SampleCode_HostedCheckout/Receipt_NVP.php"
                > 
       </script>
       ...
       <script type="text/javascript">
            ...
            function cancelCallback() {
                  alert('Payment cancelled');
        				...
        				reference				 : <?php echo json_encode($order_Ref); ?>,
    					...
    					interaction: {
        				merchant: {
            		name: 'Your Merchant Name Here',
            			address: {
            				line1: '300 Adelaide Street',
            				line2: 'Brisbane Queensland 4000'
        					},
        					  logo:  'https://prod-globalpay.azureedge.net/-/media/global-payments/images/shared/globalpayments_wordmark_blue.png'
        				}
    					},
    					session: { 
    ...
    <body>
		...
		<p align="center"> MID: <?php echo $merchantID; ?></p>
		<p align="center"> PWD: <?php echo $configArray["password"]; ?></p>
        ...
        <p style="text-align:center;"><a href= "http://bne-opsts-01/HostedCheckout_CheckoutSession/index.html"><br><br><input type="button" value="Cancel Payment and Return to Main Index Page" /></a></p>
		
		    
             <td colspan="2" height="25"><center><strong>&nbsp;Session ID: <?php echo $session_id; ?> </strong></td>
