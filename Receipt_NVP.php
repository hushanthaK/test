   ...
   <table width="60%" align="center" cellpadding="5" border="0">
   	<center>
         ...
         <tr>
          ...
          <tr>
             <td colspan="2" height="25"><center><strong>&nbsp;Session ID: <?php echo $sessID; ?> </strong></td>
         </tr>
		 <tr>
		 ...
		 <tr>
             <td colspan="2" height="25"><center><strong>&nbsp;Order Authorized Amount: <?php echo $parsed_array['totalAuthorizedAmount']; ?> </strong></td>
         </tr>
		<tr>
             <td colspan="2" height="25"><center><strong>&nbsp;Order Captured Amount: <?php echo $parsed_array['totalCapturedAmount']; ?> </strong></td>
         </tr>
		<tr>
             <td colspan="2" height="25"><center><strong>&nbsp;Order Refunded Amount: <?php echo $parsed_array['totalRefundedAmount']; ?> </strong></td>
         </tr>	
		 <tr>
             <td colspan="2" height="25"><center><strong>&nbsp;Order Result: <?php echo $parsed_array['result']; ?> </strong></td>
         </tr>
