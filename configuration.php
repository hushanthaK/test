...
$configArray["gatewayUrl"] = " https://gpcbh.gateway.mastercard.com/api/nvp"; // <-- replace MPGS Url, e.g. : https://gphk.gateway.mastercard.com/api/nvp https://gpcbh.gateway.mastercard.com/checkout/version/57/checkout.js

// Merchant ID supplied by your payments provider
$configArray["merchantId"] = "TEST037009746006"; // <-- replace merchantId, e.g. : 00055844304

// API username in the format below where Merchant ID is the same as above
$configArray["apiUsername"] = "merchant.TEST037009746006"; // <-- replace API merchantId, e.g. : merchant.00055844304

// API password which can be configured in Merchant Administration
$configArray["password"] = "ab4a222a9119d2d5e1357375684a38e6"; // <-- replace API password
